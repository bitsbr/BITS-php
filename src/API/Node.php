...
class Node
{
    const MAINNET = "https://nodes.bitsbr.org";
    const TESTNET = "https://nodes-testnet.bitsbr.org";
    const STAGENET = "https://nodes-stagenet.bitsbr.org";
    const LOCAL = "http://127.0.0.1:9899";
